...
using Soenneker.Discord.Runners.OpenApiClient.Utils.Abstract;
...
namespace Soenneker.Discord.Runners.OpenApiClient.Utils;
...
public sealed class FileOperationsUtil : IFileOperationsUtil
{
    ...
    public async ValueTask Process(CancellationToken cancellationToken = default)
    {
        ...
        string openApiDocumentUrl = _configuration["Discord:ClientGenerationUrl"] ?? "https://raw.githubusercontent.com/discord/discord-api-spec/refs/heads/main/specs/openapi.json";
        ...
        await _kiotaUtil.Generate(fixedFilePath, "DiscordOpenApiClient", Constants.Library, gitDirectory, cancellationToken).NoSync();
